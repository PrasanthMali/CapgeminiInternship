...
//import com.cg.bsmh.dao.BookDAOIOStreamImpl;
//import com.cg.bsm.dao.BookDaoCollectionImpl;
import com.cg.bsmh.dao.BookDAOJPAImpl;
import com.cg.bsmh.dao.IBookDAO;
...
public class BookServiceImpl implements IBookService {
	...
	public boolean isValidBook(Book book) throws BookStoreException{
		...
		if(!isValidPrice(book.getPrice()))
			errMsgs.add("Price must be between Rs.5 and Rs.5000");
