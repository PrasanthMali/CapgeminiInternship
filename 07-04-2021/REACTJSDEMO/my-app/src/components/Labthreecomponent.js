    ...
    render(){
        ...
        return(
            ...
            <form onSubmit={this.handleSubmit}>
                ...
                <label>Product Online:<input type="radio" value="Yes" name="Product Online" onChange={this.handleInputChange}/>Yes
                <input type="radio" value="No" name="Product Online" onChange={this.handleInputChange}/>No</label><br></br><br></br>
                ...
                <input type="checkbox" value="DMart" name="Available in Store" onChange={this.handleInputChange}/>DMart
