        ...
        return (    
            <div> 
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <label>salary:<input type="text" name="salary" value={this.state.salary} onChange={this.handleInputChange}/></label><br></br>
                    <label>department:<input type="text" name="department" value={this.state.department} onChange={this.handleInputChange}/></label><br></br>
